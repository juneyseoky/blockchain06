...
module.exports = function(){
    ...
    router.get('/create', async function(req, res){
        ...
        const receipt =await token.creat_token(input_name, input_symbol, input_decimal, input_amount)
        console.log(receipt)
        res.send(receipt)
    })
    ...
    router.get("/charge", function(req, res){
        ...
        const recipt = token.transfer(wallet, input_amount)
        console.log(recipt)
        res.redirect("/")
