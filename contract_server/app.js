...
// post형태로 데이터가 들어오는 경우 json 형태로 변경
...
app.post('/signin', function(req, res){
    ...
    // smartcontract를 이용하여 해당 값들이 존재하는 체크
    // 데이터가 존재한다면 유저가 입력한 password와 데이터의 password 값을 비교
    // 두 값이 같다면 로그인 성공
    // 그 외의 경우 로그인 실패
    smartcontract
    .methods.view_user(input_id)
    .call()
...
app.post("/signup2", function(req, res){
    ...
    .send(
        {
            gas : 200000,
            from : '0x3b9a8a86f6949AcE9AF2E8DC56D083b29ad18E3D'
        }
    )
...
app.get('/user_list', async function(req, res){
    ...
    const count = await smartcontract
                        ...
                        .call()
    // 배열값을 로드
    const ulist = await smartcontract
                        .methods
                        .view_list()
                        .call()
